<?php
/**
 * Mapper for mapping data between raw input and a Caption VO
 *
 ...
 * @package     Native
 */
class CaptionFieldMapper implements FieldMapper
{
    ...
    public function mapField($field, array $input, &$output)
    {
        ...
        if (!array_key_exists('2#120', $input)) {
            return;
        }

        $caption = new Caption($input['2#120']);

        $output = $output->withCaption($caption);
    }
}
